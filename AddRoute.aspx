<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddRoute.aspx.cs" Inherits="AddRoute" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" CssClass="btn btn-primary btn-lg" Text="Add Station" Width="173px" />
  </div>
        <asp:PlaceHolder ID="PlaceHolder1" runat="server"></asp:PlaceHolder>
        <br />
        <div>      
        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" CssClass="btn btn-primary btn-lg" Text="Complete" Width="172px" />
